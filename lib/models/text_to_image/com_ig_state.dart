...
/// 2024-09-02 文生视频也可以用这个类保存到数据库，增加部分栏位即可
///
/// IGVG => image generation video generation
///
...
class LlmIGVGResult {
  ...
  // 从字符串转
  factory LlmIGVGResult.fromRawJson(String str) =>
      LlmIGVGResult.fromJson(json.decode(str));
  // 转为字符串
  String toRawJson() => json.encode(toJson());

  factory LlmIGVGResult.fromJson(Map<String, dynamic> srcJson) =>
      _$LlmIGVGResultFromJson(srcJson);

  Map<String, dynamic> toJson() => _$LlmIGVGResultToJson(this);

  // 2024-09-02 数据库栏位已改为驼峰命名方式
  factory LlmIGVGResult.fromMap(Map<String, dynamic> map) {
    return LlmIGVGResult(
      ...
      llmSpec: map['llmSpec'] != null
          ? CusLLMSpec.fromJson(json.decode(map['llmSpec']))
          : null,
